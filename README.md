...
Trained on the [Brain Tumor MRI Dataset](https://www.kaggle.com/datasets/masoudnickparvar/brain-tumor-mri-dataset), the model achieves **~96% accuracy**.
...
|---|---|
| Test Accuracy | ~96% |
| Target Categories | glioma, meningioma, notumor, pituitary |
...
Matplotlib / Seaborn — visualization (data distribution across stages, accuracy/loss curves, confusion matrix)
