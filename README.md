...
CNN-based deep learning system that detects whether a brain MRI scan shows a tumor and, if detected, classifies it as glioma, meningioma, or pituitary tumor using a two-stage classification pipeline built with TensorFlow/Keras.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Two--Stage-CNN-brightgreen" alt="CNN">
...
Trained on the Brain Tumor MRI Dataset, the model follows a cascaded deep learning approach for brain tumor detection and classification.
